...
<form name="coupangfrm">
    <table style="width: 100%">
        ...
        <tr>
            ...
            <td style="width: 70%"><input type="password" name="name" id="" required="required"></td>
        </tr>
        <tr>
            <td style="width: 30%">phone</td>
            <td style="width: 70%"><input type="password" name="phone" id="" required="required"></td>
        </tr>
        <tr>
